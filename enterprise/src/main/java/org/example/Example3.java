...
public class Example3 extends AbstractBackstageExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        WorkspaceUtils.saveWorkspaceToJson(systemLandscapeWorkspace, new File("src/main/resources/example3/system-catalog.json"));
